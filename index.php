...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Farming Assitance Web Service</title>
	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>Farming Assitance Web Service</h2>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;"> &copy; Farming Assitance Web Service</h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Farming Culture Fam<span>dhule</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9834645241</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:Farmingculture@gmail.com" style="color:white">kaifsk903@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About FarmingCulture</b></span>
				FarmingCulture is e-commerce trading platform for grains & grocerries...
			</p>
